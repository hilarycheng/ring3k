...
IMP(NtGdiCreatePen, 4),
IMP(NtGdiCreateRectRgn, 4),
...
IMP(NtGdiGetRegionData, 3),
IMP(NtGdiGetRgnBox, 2),
...
NUL(NtGdiStartPage),
NUL(NtGdiStretchBlt),
IMP(NtGdiStretchDIBitsInternal, 16),
...
IMP(NtUserCreateAcceleratorTable, 2),
...
IMP(NtUserDestroyWindow, 1),
NUL(NtUserDisableThreadIme),
IMP(NtUserDispatchMessage, 1),
